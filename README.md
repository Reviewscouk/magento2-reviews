...
|-----------------|-------------|----------------------------|
| >= 2.4.6        | 8.1, 8.2    | reviewscouk/reviews:0.0.61 |
| >= 2.4.4        | 8.1         | reviewscouk/reviews:0.0.61 |
| <= 2.4.3        | <= 7.4      | reviewscouk/reviews:0.0.61 |
...
2. As this plugin is hosted on [packagist.org](http://packagist.org), you simply use the following to instruct composer to fetch and install the module:
    ...
    ```bash
    composer require reviewscouk/reviews:0.0.61
    ```
